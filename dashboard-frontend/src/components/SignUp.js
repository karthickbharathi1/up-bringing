    ...
    <div className='flex '>
        ...
        <div className='w-full sm:w-1/2 h-screen py-10 flex justify-center items-center'>
            ...
            <div className=' flex justify-center items-center'>
                ...
                <Link to="/login">
                    <button className='px-5 bg-white  focus:text-white text-black rounded-lg'>Login</button>
                    </Link>
                    <button className='px-5 bg-[#6557FF]  focus:text-white text-white rounded-lg'>Register</button>
            ...
            <form className='w-full' onSubmit={handleSubmit}>
                <div className='mb-10'>
                    <label htmlFor="" className='text-white mb-4'>Name</label>
                    <br />
                    <input className='w-full rounded-lg py-1 px-2 ' type="text" onChange={(e) => {setName(e.target.value)}} placeholder='Your Name'/>
                ...
                <div className='text-center'>
                    <button type='submit' className='bg-[#514ED8] text-white px-5 py-1 rounded-lg'>Register</button>
                </div>
